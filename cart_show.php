    ...
    <div id="top">
      ...
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;">'. $customer .' CART </h2>
           </div>
        </div>';
        if (isset($_SESSION['user'])) {
            if (isset($_GET['ID'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="admin.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Back to admin</a>
                             </div>
                           </div>
                           ';
            } else {
