  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    <div class="container-fluid" id="books">
      ...
      echo '<div id = ' . $mediaId . ' align="center">' .
        '<div class="star_bar"style="width:' . $nbrPixelsInDiv . 'px; height:44px; background: linear-gradient(to right, #ffc600 0px,#ffc600 ' . $numEnlightedPX . 'px,#ccc ' . $numEnlightedPX . 'px,#ccc ' . $nbrPixelsInDiv . 'px); rel=' . $getJSON . '>';
      for ($i = 1; $i <= 5; $i++) {
